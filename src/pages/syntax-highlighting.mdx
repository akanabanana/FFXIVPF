...
metaDescription: "Astro Just Docs uses PrismJS for easy code highlighting"
nav_order: 2
show_toc: false
---
...
Astro Just Docs supports live code editing examples. Edit the HTML below to see the button change in real-time.
